...
import com.example.hellocompose.ui.settingsScreen.SettingsScreenPresenterImpl
...
class MainActivity : ComponentActivity() {
    ...
    fun createGraph(
        ...
        composable("NavigateToMainScreen") {
            val loading: Boolean by mainViewModel.showMainScreen.observeAsState(false)
            MainScreen(
